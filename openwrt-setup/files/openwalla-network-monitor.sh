...
# Openwalla Network Monitor
# Tracks internet latency, outages, and physical Ethernet link changes.
...
DEFAULT_STATE_FILE="/tmp/openwalla-network-monitor.state"
...
log() {
	logger -t openwalla-network-monitor "$*"
}
